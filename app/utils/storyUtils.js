...
exports.updateStoryUsingLLM = async (storyData) => {
    ...
    // Construct a generic story prompt based on the provided story data
    const prompt = `Update a ${storyData.narrative} story with title as ${storyData.title} in Theme ${storyData.category} for role ${storyData.storyRole} in language ${storyData.language} which takes place in ${storyData.configuration}, and story should be in ${storyData.storyCountry}.
    I have changed some settings for story. The previous story was ${storyData.content}, With ${storyData.narrative} story with title as ${storyData.title} in Theme ${storyData.category} for role ${storyData.storyRole} in language ${storyData.language} which takes place in ${storyData.configuration}, and story should be in ${storyData.storyCountry}.
    `;
